...
public class Company
{
    ...
    // Classes Aninhadas: Isso permite que CompanyBuilder veja todos os
    ...
    public class CompanyBuilder
    {
        ...
        public Company Build() {
            ...
            foreach (var item in company.Employes)
            {
        ...
        public CompanyBuilder AddEmploye(string name, decimal wage)
        {
            ...
            employe.Name = name;
            employe.Wage = wage;
            company.employes.Add(employe);
            return this;
        }
    }
    public static CompanyBuilder GetBuilder() => new CompanyBuilder();
    public static void New(CompanyBuilder builder) => crr = builder.Build();
}