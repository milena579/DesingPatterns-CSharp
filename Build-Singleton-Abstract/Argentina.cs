...
public class ArgentinaHirignProcess : HiringProcess
{
    public override string Title => "Contracto funcionarito";
...
{
    public DismissalProcess CreateDismissalProcess() => new ArgentinaDismissalProcess();

    public HiringProcess CreateHiringProcess() => new ArgentinaHirignProcess();

    public WagePaymentProcess CreateWagePaymentProcess() => new ArgentinaWagePaymentProcess();
}